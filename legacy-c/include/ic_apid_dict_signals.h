...
#define SCHEMA_TRANS_INVALID_TABLE_VERSION 241
#define SCHEMA_TRANS_DROP_IN_PROGRESS 283
#define SCHEMA_TRANS_SINGLE_USER 299
#define SCHEMA_TRANS_MASTER_BUSY 701
#define SCHEMA_TRANS_WRONG_MASTER 702
static const int SCHEMA_TRANS_INVALID_FORMAT= 703;
#define SCHEMA_TRANS_COLUMN_NAME_TOO_LONG 704
#define SCHEMA_TRANS_TABLE_NAME_TOO_LONG 705
#define SCHEMA_TRANS_INCONSISTENCY 706
#define SCHEMA_TRANS_OUT_OF_TABLE_RECORDS 707
#define SCHEMA_TRANS_OUT_OF_COLUMN_RECORDS 708
#define SCHEMA_TRANS_NO_SUCH_TABLE 709
#define SCHEMA_TRANS_MASTER_NR_BUSY 711
#define SCHEMA_TRANS_COLUMN_NAME_TWICE 720
#define SCHEMA_TRANS_TABLE_ALREADY_EXIST 721
#define SCHEMA_TRANS_INVALID_ARRAY_SIZE 736
#define SCHEMA_TRANS_ARRAY_SIZE_TOO_BIG 737
#define SCHEMA_TRANS_RECORD_SIZE_TOO_BIG 738
#define SCHEMA_TRANS_INVALID_PRIMARY_KEY_SIZE 739
#define SCHEMA_TRANS_NULLABLE_PRIMARY_KEY 740
#define SCHEMA_TRANS_CHANGE_NOT_SUPPORTED 741
#define SCHEMA_TRANS_INVALID_CHARSET 743
#define SCHEMA_TRANS_INVALID_TABLESPACE 755
#define SCHEMA_TRANS_INDEX_COLUMN_ON_DISK 756
static const int SCHEMA_TRANS_NO_VARSIZE_BITFIELD_ALLOWED= 757;
#define SCHEMA_TRANS_NO_TABLESPACE 758
#define SCHEMA_TRANS_INVALID_TABLESPACE_VERSION 759
#define SCHEMA_TRANS_BACKUP_IN_PROGRESS 762
#define SCHEMA_TRANS_INCOMPATIBLE_VERSIONS 763
#define SCHEMA_TRANS_OUT_OF_BUFFER 773
#define SCHEMA_TRANS_TABLE_IS_TEMPORARY_INDEX_ERROR 776
#define SCHEMA_TRANS_TABLE_ISNT_TEMPORARY_INDEX_ERROR 777
#define SCHEMA_TRANS_NO_LOGGING_TEMPORARY_TABLE 778
#define SCHEMA_TRANS_TOO_MANY_TRANS 780
#define SCHEMA_TRANS_INVALID_NDB_TRANSID 781
#define SCHEMA_TRANS_INVALID_MY_TRANSID 782
#define SCHEMA_TRANS_INVALID_STATE 784
#define SCHEMA_TRANS_ACTIVE_SCHEMA_TRANSACTION 785
#define SCHEMA_TRANS_NODE_FAILURE 786
#define SCHEMA_TRANS_ABORTED 787
#define SCHEMA_TRANS_INVALID_HASH_MAP 790
#define SCHEMA_TRANS_TABLE_DEF_TOO_BIG 793
#define SCHEMA_TRANS_REQUIRES_UPGRADE 794
#define SCHEMA_TRANS_OUT_OF_MEMORY 796
#define SCHEMA_TRANS_TOO_MANY_FRAGMENTS 1224
#define SCHEMA_TRANS_NO_DROP_TABLE_RESOURCES 1229
#define SCHEMA_TRANS_TRIGGER_NOT_FOUND 4238
#define SCHEMA_TRANS_TRIGGER_ALREADY_THERE 4239
#define SCHEMA_TRANS_INDEX_NAME_TOO_LONG 4241
#define SCHEMA_TRANS_TOO_MANY_INDEXES 4242
#define SCHEMA_TRANS_INDEX_NOT_FOUND 4243
#define SCHEMA_TRANS_INDEX_EXISTS 4244
#define SCHEMA_TRANS_COLUMN_NULLABLE 4246
#define SCHEMA_TRANS_BAD_REQUEST 4247
#define SCHEMA_TRANS_INVALID_INDEX_NAME 4248
#define SCHEMA_TRANS_INVALID_PRIMARY_TABLE 4249
#define SCHEMA_TRANS_INVALID_INDEX_TYPE 4250
#define SCHEMA_TRANS_INDEX_NOT_UNIQUE 4251
#define SCHEMA_TRANS_INDEX_ALLOCATION_ERROR 4252
#define SCHEMA_TRANS_CREATE_INDEX_TABLE_FAILURE 4253
#define SCHEMA_TRANS_NOT_AN_INDEX 4254
#define SCHEMA_TRANS_DUPLICATE_COLUMN_IN_INDEX 4258
#define SCHEMA_TRANS_BAD_STATE 4347
#define SCHEMA_TRANS_INDEX_INCONSISTENCY 4348
...
/* Mandatory */
#define IC_TABLE_NAME_KEY 1

/* Mandatory in getting table info from kernel */
#define IC_TABLE_ID_KEY 2

/* Mandatory in getting table info from kernel */
#define IC_TABLE_VERSION_KEY 3

#define IC_TABLE_LOGGED_KEY 4
static const guint32 IC_TABLE_LOGGED_DEFAULT= 1;

/* Mandatory */
#define IC_NUM_PKEY_COL_KEY 5
static const guint32 IC_NUM_PKEY_COL_DEFAULT= 0;

/* Mandatory */
#define IC_NUM_COL_KEY 6
static const guint32 IC_NUM_COL_DEFAULT= 0;

/* Mandatory */
#define IC_NUM_NULL_COL_KEY 7
static const guint32 IC_NUM_NULL_COL_DEFAULT= 0;

/* Always 0, never changed */
#define IC_NUM_VARIABLE_COL_KEY 8
static const guint32 IC_NUM_VARIABLE_COL_DEFAULT= 0;

/* Always 6, never changed */
#define IC_TABLE_K_VALUE_KEY 9
static const guint32 IC_TABLE_K_VALUE_DEFAULT= 6;

#define IC_MIN_LOAD_FACTOR_KEY 10
static const guint32 IC_MIN_LOAD_FACTOR_DEFAULT= 78;

#define IC_MAX_LOAD_FACTOR_KEY 11
static const guint32 IC_MAX_LOAD_FACTOR_DEFAULT= 80;
static const guint32 IC_MAX_LOAD_FACTOR_OUR_DEFAULT= 90;

#define IC_PKEY_LEN_KEY 12
static const guint32 IC_PKEY_LEN_DEFAULT= 0;

#define IC_FRAGMENT_TYPE_KEY 13
/* Hashmap partition */
static const guint32 IC_FRAGMENT_TYPE_DEFAULT= 9;

#define IC_TABLE_TYPE_KEY 18
/* User Table */
static const guint32 IC_TABLE_TYPE_DEFAULT= 2;

/* Only used for indexes, defaults to empty string */
#define IC_PRIMARY_TABLE_KEY 19
/* Only used for indexes, defaults to RNIL */
#define IC_PRIMARY_TABLE_ID_KEY 20

/* IndexState defaults to -1 */
#define IC_INDEX_STATE_KEY 21

/* Trigger ids defaults to RNIL */
#define IC_INSERT_TRIGGER_ID_KEY 22
#define IC_UPDATE_TRIGGER_ID_KEY 23
#define IC_DELETE_TRIGGER_ID_KEY 24
#define IC_CUSTOM_TRIGGER_ID_KEY 25

#define IC_FRM_LEN_KEY 26
#define IC_FRM_DATA_KEY 27

#define IC_TABLE_TEMPORARY_KEY 28
static const guint32 IC_TABLE_TEMPORARY_DEFAULT= 0;

#define IC_FORCE_VAR_PART_KEY 29 /* Always 0, never changed */

#define IC_FRAGMENT_COUNT_KEY 128

#define IC_FRAGMENT_DATA_LEN_KEY 129
#define IC_FRAGMENT_DATA_KEY 130

/* Tablespace id defaults to RNIL */
#define IC_TABLESPACE_ID_KEY 131
/* Tablespace version defaults to minus one */
#define IC_TABLESPACE_VERSION_KEY 132

#define IC_TABLESPACE_DATA_LEN_KEY 133
#define IC_TABLESPACE_DATA_KEY 134

#define IC_RANGE_LIST_DATA_LEN_KEY 135
#define IC_RANGE_LIST_DATA_KEY 136

#define IC_REPLICA_LIST_DATA_LEN_KEY 137
#define IC_REPLICA_LIST_DATA_KEY 138

/* Default max rows is 0 */
#define IC_MAX_ROWS_LOW_KEY 139
#define IC_MAX_ROWS_HIGH_KEY 140

#define IC_DEFAULT_NUM_PARTITIONS_FLAG_KEY 141
static const guint32 IC_DEFAULT_NUM_PARTITIONS_FLAG_DEFAULT= 1;
#define IC_LINEAR_HASH_FLAG_KEY 142
static const guint32 IC_LINEAR_HASH_FLAG_DEFAULT= 1;

/* Default min rows is 0 */
#define IC_MIN_ROWS_LOW_KEY 143
#define IC_MIN_ROWS_HIGH_KEY 144

#define IC_ROW_GCI_FLAG_KEY 150
static const guint32 IC_ROW_GCI_FLAG_DEFAULT= 1;

#define IC_ROW_CHECKSUM_FLAG_KEY 151
static const guint32 IC_ROW_CHECKSUM_FLAG_DEFAULT= 1;

#define IC_SINGLE_USER_MODE_KEY 152
static const guint32 IC_SINGLE_USER_MODE_DEFAULT= 0;

/* Defaults to RNIL */
#define IC_HASH_MAP_ID_KEY 153
/* Defaults to -1 */
#define IC_HASH_MAP_VERSION_KEY 154

/* Defaults to main memory storage */
#define IC_TABLE_STORAGE_TYPE_KEY 155
static const guint32 IC_TABLE_STORAGE_TYPE_DEFAULT= 0;

/* Defaults to 0 */
#define IC_EXTRA_ROW_GCI_BITS_KEY 156

/* Defaults to 0 */
#define IC_EXTRA_ROW_AUTHOR_BITS_KEY 157

static const guint32 IC_TABLE_END_KEY= 999;
static const guint32 IC_TABLE_END_DEFAULT= 1;

/* Mandatory to have a name */
#define IC_COLUMN_NAME_KEY 1000

/* Id defaults to -1, set by kernel */
#define IC_COLUMN_ID_KEY 1001

/* Type deprecated, always set to -1 */
#define IC_COLUMN_TYPE_KEY 1002

#define IC_COLUMN_SIZE_KEY 1003
static const guint32 IC_COLUMN_SIZE_DEFAULT= 5;

#define IC_COLUMN_ARRAY_SIZE_KEY 1005
static const guint32 IC_COLUMN_ARRAY_SIZE_DEFAULT= 1;

#define IC_COLUMN_PKEY_FLAG_KEY 1006
static const guint32 IC_COLUMN_PKEY_FLAG_DEFAULT= 0;

#define IC_COLUMN_STORAGE_TYPE_KEY 1007
static const guint32 IC_COLUMN_STORAGE_TYPE_DEFAULT= 0;

#define IC_COLUMN_NULL_FLAG_KEY 1008
static const guint32 IC_COLUMN_NULL_FLAG_DEFAULT= 0;

#define IC_COLUMN_DYNAMIC_FLAG_KEY 1009
static const guint32 IC_COLUMN_DYNAMIC_FLAG_DEFAULT= 0;

#define IC_COLUMN_DISTRIBUTION_KEY_FLAG_KEY 1010
static const guint32 IC_COLUMN_DISTRIBUTION_KEY_FLAG_DEFAULT= 0;

#define IC_COLUMN_EXT_TYPE_KEY 1013
static const guint32 IC_COLUMN_EXT_TYPE_DEFAULT= 0;

/* The rest of these types defaults to 0 */
#define IC_COLUMN_EXT_PRECISION_KEY 1014
#define IC_COLUMN_EXT_SCALE_KEY 1015
#define IC_COLUMN_EXT_LEN_KEY 1016

#define IC_COLUMN_AUTO_INCREMENT_FLAG_KEY 1017
static const guint32 IC_COLUMN_AUTO_INCREMENT_FLAG_DEFAULT= 0;

#define IC_COLUMN_ARRAY_TYPE_KEY 1019
static const guint32 IC_COLUMN_ARRAY_TYPE_DEFAULT= 0;


/* Defaults to 0 length and empty value */
#define IC_COLUMN_DEFAULT_VALUE_LEN_KEY 1020
static const guint32 IC_COLUMN_DEFAULT_VALUE_LEN_DEFAULT= 0;
#define IC_COLUMN_DEFAULT_VALUE_KEY 1021

#define IC_COLUMN_END_KEY 1999
